...
### Hidden Characters
If there are characters in an [[Core Rules/Actions and Turn Time/Events\|event]] that the [[TTRPG Basics/Players\|Players]] are not aware of or is hidden, then the [[TTRPG Basics/GM\|GM]] may choose for one of those [[Core Rules/Characters and Rolling/Character\|characters]] to go first instead of the [[Core Rules/Characters and Rolling/Character\|Character]] the [[TTRPG Basics/Players\|Players]] vote on if a vote takes place.